...
uint8_t DMA1_sr_tcif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA1->LISR, 1, 5);
		break;
		case 1:
			value = exe()->get_block(DMA1->LISR, 1, 11);
		break;
		case 2:
			value = exe()->get_block(DMA1->LISR, 1, 21);
		break;
		case 3:
			value = exe()->get_block(DMA1->LISR, 1, 27);
		break;
		case 4:
			value = exe()->get_block(DMA1->HISR, 1, 5);
		break;
		case 5:
			value = exe()->get_block(DMA1->HISR, 1, 11);
		break;
		case 6:
			value = exe()->get_block(DMA1->HISR, 1, 21);
		break;
		case 7:
			value = exe()->get_block(DMA1->HISR, 1, 27);
		break;
	default: break;
	}
	return value;
...
void DMA1_sr_clear_tcif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA1->LIFCR, 1, 5, 1);
		break;
		case 1:
			exe()->write_block(&DMA1->LIFCR, 1, 11, 1);
		break;
		case 2:
			exe()->write_block(&DMA1->LIFCR, 1, 21, 1);
		break;
		case 3:
			exe()->write_block(&DMA1->LIFCR, 1, 27, 1);
		break;
		case 4:
			exe()->write_block(&DMA1->HIFCR, 1, 5, 1);
		break;
		case 5:
			exe()->write_block(&DMA1->HIFCR, 1, 11, 1);
		break;
		case 6:
			exe()->write_block(&DMA1->HIFCR, 1, 21, 1);
		break;
		case 7:
			exe()->write_block(&DMA1->HIFCR, 1, 27, 1);
		break;
		default: break;
	}
}
uint8_t DMA1_sr_htif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA1->LISR, 1, 4);
		break;
		case 1:
			value = exe()->get_block(DMA1->LISR, 1, 10);
		break;
		case 2:
			value = exe()->get_block(DMA1->LISR, 1, 20);
		break;
		case 3:
			value = exe()->get_block(DMA1->LISR, 1, 26);
		break;
		case 4:
			value = exe()->get_block(DMA1->HISR, 1, 4);
		break;
		case 5:
			value = exe()->get_block(DMA1->HISR, 1, 10);
		break;
		case 6:
			value = exe()->get_block(DMA1->HISR, 1, 20);
		break;
		case 7:
			value = exe()->get_block(DMA1->HISR, 1, 26);
		break;
	default: break;
	}
	return value;
...
void DMA1_sr_clear_htif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA1->LIFCR, 1, 4, 1);
		break;
		case 1:
			exe()->write_block(&DMA1->LIFCR, 1, 10, 1);
		break;
		case 2:
			exe()->write_block(&DMA1->LIFCR, 1, 20, 1);
		break;
		case 3:
			exe()->write_block(&DMA1->LIFCR, 1, 26, 1);
		break;
		case 4:
			exe()->write_block(&DMA1->HIFCR, 1, 4, 1);
		break;
		case 5:
			exe()->write_block(&DMA1->HIFCR, 1, 10, 1);
		break;
		case 6:
			exe()->write_block(&DMA1->HIFCR, 1, 20, 1);
		break;
		case 7:
			exe()->write_block(&DMA1->HIFCR, 1, 26, 1);
		break;
		default: break;
	}
}
uint8_t DMA1_sr_teif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA1->LISR, 1, 3);
		break;
		case 1:
			value = exe()->get_block(DMA1->LISR, 1, 9);
		break;
		case 2:
			value = exe()->get_block(DMA1->LISR, 1, 19);
		break;
		case 3:
			value = exe()->get_block(DMA1->LISR, 1, 25);
		break;
		case 4:
			value = exe()->get_block(DMA1->HISR, 1, 3);
		break;
		case 5:
			value = exe()->get_block(DMA1->HISR, 1, 9);
		break;
		case 6:
			value = exe()->get_block(DMA1->HISR, 1, 19);
		break;
		case 7:
			value = exe()->get_block(DMA1->HISR, 1, 25);
		break;
	default: break;
	}
	return value;
...
void DMA1_sr_clear_teif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA1->LIFCR, 1, 3, 1);
		break;
		case 1:
			exe()->write_block(&DMA1->LIFCR, 1, 9, 1);
		break;
		case 2:
			exe()->write_block(&DMA1->LIFCR, 1, 19, 1);
		break;
		case 3:
			exe()->write_block(&DMA1->LIFCR, 1, 25, 1);
		break;
		case 4:
			exe()->write_block(&DMA1->HIFCR, 1, 3, 1);
		break;
		case 5:
			exe()->write_block(&DMA1->HIFCR, 1, 9, 1);
		break;
		case 6:
			exe()->write_block(&DMA1->HIFCR, 1, 19, 1);
		break;
		case 7:
			exe()->write_block(&DMA1->HIFCR, 1, 25, 1);
		break;
		default: break;
	}
}
uint8_t DMA1_sr_dmeif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA1->LISR, 1, 2);
		break;
		case 1:
			value = exe()->get_block(DMA1->LISR, 1, 8);
		break;
		case 2:
			value = exe()->get_block(DMA1->LISR, 1, 18);
		break;
		case 3:
			value = exe()->get_block(DMA1->LISR, 1, 24);
		break;
		case 4:
			value = exe()->get_block(DMA1->HISR, 1, 2);
		break;
		case 5:
			value = exe()->get_block(DMA1->HISR, 1, 8);
		break;
		case 6:
			value = exe()->get_block(DMA1->HISR, 1, 18);
		break;
		case 7:
			value = exe()->get_block(DMA1->HISR, 1, 24);
		break;
	default: break;
	}
	return value;
...
void DMA1_sr_clear_dmeif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA1->LIFCR, 1, 2, 1);
		break;
		case 1:
			exe()->write_block(&DMA1->LIFCR, 1, 8, 1);
		break;
		case 2:
			exe()->write_block(&DMA1->LIFCR, 1, 18, 1);
		break;
		case 3:
			exe()->write_block(&DMA1->LIFCR, 1, 24, 1);
		break;
		case 4:
			exe()->write_block(&DMA1->HIFCR, 1, 2, 1);
		break;
		case 5:
			exe()->write_block(&DMA1->HIFCR, 1, 8, 1);
		break;
		case 6:
			exe()->write_block(&DMA1->HIFCR, 1, 18, 1);
		break;
		case 7:
			exe()->write_block(&DMA1->HIFCR, 1, 24, 1);
		break;
		default: break;
	}
}
uint8_t DMA1_sr_feif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA1->LISR, 1, 0);
		break;
		case 1:
			value = exe()->get_block(DMA1->LISR, 1, 6);
		break;
		case 2:
			value = exe()->get_block(DMA1->LISR, 1, 16);
		break;
		case 3:
			value = exe()->get_block(DMA1->LISR, 1, 22);
		break;
		case 4:
			value = exe()->get_block(DMA1->HISR, 1, 0);
		break;
		case 5:
			value = exe()->get_block(DMA1->HISR, 1, 6);
		break;
		case 6:
			value = exe()->get_block(DMA1->HISR, 1, 16);
		break;
		case 7:
			value = exe()->get_block(DMA1->HISR, 1, 22);
		break;
	default: break;
	}
	return value;
...
void DMA1_sr_clear_feif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA1->LIFCR, 1, 0, 1);
		break;
		case 1:
			exe()->write_block(&DMA1->LIFCR, 1, 6, 1);
		break;
		case 2:
			exe()->write_block(&DMA1->LIFCR, 1, 16, 1);
		break;
		case 3:
			exe()->write_block(&DMA1->LIFCR, 1, 22, 1);
		break;
		case 4:
			exe()->write_block(&DMA1->HIFCR, 1, 0, 1);
		break;
		case 5:
			exe()->write_block(&DMA1->HIFCR, 1, 6, 1);
		break;
		case 6:
			exe()->write_block(&DMA1->HIFCR, 1, 16, 1);
		break;
		case 7:
			exe()->write_block(&DMA1->HIFCR, 1, 22, 1);
		break;
		default: break;
	}
}
...
{
	exe()->write_block(&DMA1_Stream0->CR, 3, 25, value);
}
void DMA1_stream0_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->CR, 2, 23, value);
}
void DMA1_stream0_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->CR, 2, 21, value);
}
void DMA1_stream0_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 19, state);
}
void DMA1_stream0_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 18, state);
}
void DMA1_stream0_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->CR, 2, 16, value);
}
void DMA1_stream0_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 15, state);
}
void DMA1_stream0_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->CR, 2, 13, value);
}
void DMA1_stream0_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->CR, 2, 11, value);
}
void DMA1_stream0_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 10, state);
}
void DMA1_stream0_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 9, state);
}
void DMA1_stream0_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 8, state);
}
void DMA1_stream0_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->CR, 2, 7, value);
}
void DMA1_stream0_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 5, state);
}
void DMA1_stream0_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 4, state);
}
void DMA1_stream0_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 3, state);
}
void DMA1_stream0_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 2, state);
}
void DMA1_stream0_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 1, state);
}
void DMA1_stream0_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream1->CR, 3, 25, value);
}
void DMA1_stream1_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->CR, 2, 23, value);
}
void DMA1_stream1_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->CR, 2, 21, value);
}
void DMA1_stream1_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 19, state);
}
void DMA1_stream1_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 18, state);
}
void DMA1_stream1_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->CR, 2, 16, value);
}
void DMA1_stream1_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 15, state);
}
void DMA1_stream1_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->CR, 2, 13, value);
}
void DMA1_stream1_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->CR, 2, 11, value);
}
void DMA1_stream1_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 10, state);
}
void DMA1_stream1_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 9, state);
}
void DMA1_stream1_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 8, state);
}
void DMA1_stream1_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->CR, 2, 7, value);
}
void DMA1_stream1_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 5, state);
}
void DMA1_stream1_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 4, state);
}
void DMA1_stream1_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 3, state);
}
void DMA1_stream1_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 2, state);
}
void DMA1_stream1_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 1, state);
}
void DMA1_stream1_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream2->CR, 3, 25, value);
}
void DMA1_stream2_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->CR, 2, 23, value);
}
void DMA1_stream2_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->CR, 2, 21, value);
}
void DMA1_stream2_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 19, state);
}
void DMA1_stream2_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 18, state);
}
void DMA1_stream2_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->CR, 2, 16, value);
}
void DMA1_stream2_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 15, state);
}
void DMA1_stream2_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->CR, 2, 13, value);
}
void DMA1_stream2_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->CR, 2, 11, value);
}
void DMA1_stream2_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 10, state);
}
void DMA1_stream2_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 9, state);
}
void DMA1_stream2_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 8, state);
}
void DMA1_stream2_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->CR, 2, 7, value);
}
void DMA1_stream2_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 5, state);
}
void DMA1_stream2_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 4, state);
}
void DMA1_stream2_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 3, state);
}
void DMA1_stream2_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 2, state);
}
void DMA1_stream2_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 1, state);
}
void DMA1_stream2_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream3->CR, 3, 25, value);
}
void DMA1_stream3_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->CR, 2, 23, value);
}
void DMA1_stream3_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->CR, 2, 21, value);
}
void DMA1_stream3_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 19, state);
}
void DMA1_stream3_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 18, state);
}
void DMA1_stream3_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->CR, 2, 16, value);
}
void DMA1_stream3_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 15, state);
}
void DMA1_stream3_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->CR, 2, 13, value);
}
void DMA1_stream3_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->CR, 2, 11, value);
}
void DMA1_stream3_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 10, state);
}
void DMA1_stream3_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 9, state);
}
void DMA1_stream3_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 8, state);
}
void DMA1_stream3_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->CR, 2, 7, value);
}
void DMA1_stream3_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 5, state);
}
void DMA1_stream3_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 4, state);
}
void DMA1_stream3_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 3, state);
}
void DMA1_stream3_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 2, state);
}
void DMA1_stream3_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 1, state);
}
void DMA1_stream3_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream4->CR, 3, 25, value);
}
void DMA1_stream4_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->CR, 2, 23, value);
}
void DMA1_stream4_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->CR, 2, 21, value);
}
void DMA1_stream4_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 19, state);
}
void DMA1_stream4_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 18, state);
}
void DMA1_stream4_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->CR, 2, 16, value);
}
void DMA1_stream4_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 15, state);
}
void DMA1_stream4_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->CR, 2, 13, value);
}
void DMA1_stream4_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->CR, 2, 11, value);
}
void DMA1_stream4_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 10, state);
}
void DMA1_stream4_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 9, state);
}
void DMA1_stream4_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 8, state);
}
void DMA1_stream4_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->CR, 2, 7, value);
}
void DMA1_stream4_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 5, state);
}
void DMA1_stream4_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 4, state);
}
void DMA1_stream4_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 3, state);
}
void DMA1_stream4_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 2, state);
}
void DMA1_stream4_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 1, state);
}
void DMA1_stream4_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream5->CR, 3, 25, value);
}
void DMA1_stream5_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->CR, 2, 23, value);
}
void DMA1_stream5_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->CR, 2, 21, value);
}
void DMA1_stream5_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 19, state);
}
void DMA1_stream5_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 18, state);
}
void DMA1_stream5_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->CR, 2, 16, value);
}
void DMA1_stream5_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 15, state);
}
void DMA1_stream5_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->CR, 2, 13, value);
}
void DMA1_stream5_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->CR, 2, 11, value);
}
void DMA1_stream5_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 10, state);
}
void DMA1_stream5_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 9, state);
}
void DMA1_stream5_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 8, state);
}
void DMA1_stream5_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->CR, 2, 7, value);
}
void DMA1_stream5_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 5, state);
}
void DMA1_stream5_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 4, state);
}
void DMA1_stream5_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 3, state);
}
void DMA1_stream5_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 2, state);
}
void DMA1_stream5_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 1, state);
}
void DMA1_stream5_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream6->CR, 3, 25, value);
}
void DMA1_stream6_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->CR, 2, 23, value);
}
void DMA1_stream6_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->CR, 2, 21, value);
}
void DMA1_stream6_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 19, state);
}
void DMA1_stream6_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 18, state);
}
void DMA1_stream6_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->CR, 2, 16, value);
}
void DMA1_stream6_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 15, state);
}
void DMA1_stream6_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->CR, 2, 13, value);
}
void DMA1_stream6_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->CR, 2, 11, value);
}
void DMA1_stream6_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 10, state);
}
void DMA1_stream6_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 9, state);
}
void DMA1_stream6_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 8, state);
}
void DMA1_stream6_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->CR, 2, 7, value);
}
void DMA1_stream6_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 5, state);
}
void DMA1_stream6_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 4, state);
}
void DMA1_stream6_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 3, state);
}
void DMA1_stream6_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 2, state);
}
void DMA1_stream6_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 1, state);
}
void DMA1_stream6_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream7->CR, 3, 25, value);
}
void DMA1_stream7_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->CR, 2, 23, value);
}
void DMA1_stream7_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->CR, 2, 21, value);
}
void DMA1_stream7_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 19, state);
}
void DMA1_stream7_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 18, state);
}
void DMA1_stream7_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->CR, 2, 16, value);
}
void DMA1_stream7_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 15, state);
}
void DMA1_stream7_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->CR, 2, 13, value);
}
void DMA1_stream7_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->CR, 2, 11, value);
}
void DMA1_stream7_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 10, state);
}
void DMA1_stream7_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 9, state);
}
void DMA1_stream7_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 8, state);
}
void DMA1_stream7_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->CR, 2, 7, value);
}
void DMA1_stream7_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 5, state);
}
void DMA1_stream7_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 4, state);
}
void DMA1_stream7_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 3, state);
}
void DMA1_stream7_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 2, state);
}
void DMA1_stream7_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 1, state);
}
void DMA1_stream7_cr_en(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA1_Stream0->FCR, 1, 7, state);
}
void DMA1_stream0_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->FCR, 3, 3, value);
}
void DMA1_stream0_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream0->FCR, 1, 2, state);
}
void DMA1_stream0_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream0->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA1_Stream1->FCR, 1, 7, state);
}
void DMA1_stream1_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->FCR, 3, 3, value);
}
void DMA1_stream1_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream1->FCR, 1, 2, state);
}
void DMA1_stream1_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream1->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA1_Stream2->FCR, 1, 7, state);
}
void DMA1_stream2_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->FCR, 3, 3, value);
}
void DMA1_stream2_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream2->FCR, 1, 2, state);
}
void DMA1_stream2_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream2->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA1_Stream3->FCR, 1, 7, state);
}
void DMA1_stream3_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->FCR, 3, 3, value);
}
void DMA1_stream3_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream3->FCR, 1, 2, state);
}
void DMA1_stream3_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream3->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA1_Stream4->FCR, 1, 7, state);
}
void DMA1_stream4_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->FCR, 3, 3, value);
}
void DMA1_stream4_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream4->FCR, 1, 2, state);
}
void DMA1_stream4_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream4->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA1_Stream5->FCR, 1, 7, state);
}
void DMA1_stream5_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->FCR, 3, 3, value);
}
void DMA1_stream5_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream5->FCR, 1, 2, state);
}
void DMA1_stream5_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream5->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA1_Stream6->FCR, 1, 7, state);
}
void DMA1_stream6_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->FCR, 3, 3, value);
}
void DMA1_stream6_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream6->FCR, 1, 2, state);
}
void DMA1_stream6_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream6->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA1_Stream7->FCR, 1, 7, state);
}
void DMA1_stream7_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->FCR, 3, 3, value);
}
void DMA1_stream7_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA1_Stream7->FCR, 1, 2, state);
}
void DMA1_stream7_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA1_Stream7->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&RCC->AHB1ENR, 1, 22, 1);
	// Filter to Default
	...
	if( p_addr && m_addr ){
		...
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 0, 0);
		for(time_out = 200; exe()->get_block((DMA1_Stream0 + stream_n)->CR, 1, 0) && time_out; time_out--);
		/*** Parameter Configure ***/
		(DMA1_Stream0 + stream_n)->PAR = (volatile uint32_t) p_addr;
		(DMA1_Stream0 + stream_n)->M0AR = (volatile uint32_t) m_addr;
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 5, 0); // 0 -> dma, 1 -> peri
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 3, 25, channel_n); // channel
		(DMA1_Stream0 + stream_n)->NDTR = quant_d; //
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 2, 13, m_size); // msize 2 -> 32bit
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 2, 11, p_size); // psize 1 -> 16bit
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 2, 16, priority); // priority
		if(dir){
			exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 2, 6, 1); // DIR
			exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 9, 1); // PINC
			exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 10, 0); // MINC
		}else{
			exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 2, 6, 0); // DIR
			exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 9, 0); // PINC
			exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 10, 1); // MINC
		}
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 8, 1); // CIRC
		exe()->write_block(&(DMA1_Stream0 + stream_n)->CR, 1, 0, 1); // ENABLE
	}
}
/*** Inic FUNC ***/
STM32FXXX_DMA_func* stm32fxxx_dma1_func_inic(void)
...
uint8_t DMA2_sr_tcif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA2->LISR, 1, 5);
		break;
		case 1:
			value = exe()->get_block(DMA2->LISR, 1, 11);
		break;
		case 2:
			value = exe()->get_block(DMA2->LISR, 1, 21);
		break;
		case 3:
			value = exe()->get_block(DMA2->LISR, 1, 27);
		break;
		case 4:
			value = exe()->get_block(DMA2->HISR, 1, 5);
		break;
		case 5:
			value = exe()->get_block(DMA2->HISR, 1, 11);
		break;
		case 6:
			value = exe()->get_block(DMA2->HISR, 1, 21);
		break;
		case 7:
			value = exe()->get_block(DMA2->HISR, 1, 27);
		break;
	default: break;
	}
	return value;
...
void DMA2_sr_clear_tcif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA2->LIFCR, 1, 5, 1);
		break;
		case 1:
			exe()->write_block(&DMA2->LIFCR, 1, 11, 1);
		break;
		case 2:
			exe()->write_block(&DMA2->LIFCR, 1, 21, 1);
		break;
		case 3:
			exe()->write_block(&DMA2->LIFCR, 1, 27, 1);
		break;
		case 4:
			exe()->write_block(&DMA2->HIFCR, 1, 5, 1);
		break;
		case 5:
			exe()->write_block(&DMA2->HIFCR, 1, 11, 1);
		break;
		case 6:
			exe()->write_block(&DMA2->HIFCR, 1, 21, 1);
		break;
		case 7:
			exe()->write_block(&DMA2->HIFCR, 1, 27, 1);
		break;
		default: break;
	}
}
uint8_t DMA2_sr_htif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA2->LISR, 1, 4);
		break;
		case 1:
			value = exe()->get_block(DMA2->LISR, 1, 10);
		break;
		case 2:
			value = exe()->get_block(DMA2->LISR, 1, 20);
		break;
		case 3:
			value = exe()->get_block(DMA2->LISR, 1, 26);
		break;
		case 4:
			value = exe()->get_block(DMA2->HISR, 1, 4);
		break;
		case 5:
			value = exe()->get_block(DMA2->HISR, 1, 10);
		break;
		case 6:
			value = exe()->get_block(DMA2->HISR, 1, 20);
		break;
		case 7:
			value = exe()->get_block(DMA2->HISR, 1, 26);
		break;
	default: break;
	}
	return value;
...
void DMA2_sr_clear_htif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA2->LIFCR, 1, 4, 1);
		break;
		case 1:
			exe()->write_block(&DMA2->LIFCR, 1, 10, 1);
		break;
		case 2:
			exe()->write_block(&DMA2->LIFCR, 1, 20, 1);
		break;
		case 3:
			exe()->write_block(&DMA2->LIFCR, 1, 26, 1);
		break;
		case 4:
			exe()->write_block(&DMA2->HIFCR, 1, 4, 1);
		break;
		case 5:
			exe()->write_block(&DMA2->HIFCR, 1, 10, 1);
		break;
		case 6:
			exe()->write_block(&DMA2->HIFCR, 1, 20, 1);
		break;
		case 7:
			exe()->write_block(&DMA2->HIFCR, 1, 26, 1);
		break;
		default: break;
	}
}
uint8_t DMA2_sr_teif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA2->LISR, 1, 3);
		break;
		case 1:
			value = exe()->get_block(DMA2->LISR, 1, 9);
		break;
		case 2:
			value = exe()->get_block(DMA2->LISR, 1, 19);
		break;
		case 3:
			value = exe()->get_block(DMA2->LISR, 1, 25);
		break;
		case 4:
			value = exe()->get_block(DMA2->HISR, 1, 3);
		break;
		case 5:
			value = exe()->get_block(DMA2->HISR, 1, 9);
		break;
		case 6:
			value = exe()->get_block(DMA2->HISR, 1, 19);
		break;
		case 7:
			value = exe()->get_block(DMA2->HISR, 1, 25);
		break;
	default: break;
	}
	return value;
...
void DMA2_sr_clear_teif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA2->LIFCR, 1, 3, 1);
		break;
		case 1:
			exe()->write_block(&DMA2->LIFCR, 1, 9, 1);
		break;
		case 2:
			exe()->write_block(&DMA2->LIFCR, 1, 19, 1);
		break;
		case 3:
			exe()->write_block(&DMA2->LIFCR, 1, 25, 1);
		break;
		case 4:
			exe()->write_block(&DMA2->HIFCR, 1, 3, 1);
		break;
		case 5:
			exe()->write_block(&DMA2->HIFCR, 1, 9, 1);
		break;
		case 6:
			exe()->write_block(&DMA2->HIFCR, 1, 19, 1);
		break;
		case 7:
			exe()->write_block(&DMA2->HIFCR, 1, 25, 1);
		break;
		default: break;
	}
}
uint8_t DMA2_sr_dmeif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA2->LISR, 1, 2);
		break;
		case 1:
			value = exe()->get_block(DMA2->LISR, 1, 8);
		break;
		case 2:
			value = exe()->get_block(DMA2->LISR, 1, 18);
		break;
		case 3:
			value = exe()->get_block(DMA2->LISR, 1, 24);
		break;
		case 4:
			value = exe()->get_block(DMA2->HISR, 1, 2);
		break;
		case 5:
			value = exe()->get_block(DMA2->HISR, 1, 8);
		break;
		case 6:
			value = exe()->get_block(DMA2->HISR, 1, 18);
		break;
		case 7:
			value = exe()->get_block(DMA2->HISR, 1, 24);
		break;
	default: break;
	}
	return value;
...
void DMA2_sr_clear_dmeif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA2->LIFCR, 1, 2, 1);
		break;
		case 1:
			exe()->write_block(&DMA2->LIFCR, 1, 8, 1);
		break;
		case 2:
			exe()->write_block(&DMA2->LIFCR, 1, 18, 1);
		break;
		case 3:
			exe()->write_block(&DMA2->LIFCR, 1, 24, 1);
		break;
		case 4:
			exe()->write_block(&DMA2->HIFCR, 1, 2, 1);
		break;
		case 5:
			exe()->write_block(&DMA2->HIFCR, 1, 8, 1);
		break;
		case 6:
			exe()->write_block(&DMA2->HIFCR, 1, 18, 1);
		break;
		case 7:
			exe()->write_block(&DMA2->HIFCR, 1, 24, 1);
		break;
		default: break;
	}
}
uint8_t DMA2_sr_feif(uint8_t stream_n)
{
	...
	switch(stream_n){
		case 0:
			value = exe()->get_block(DMA2->LISR, 1, 0);
		break;
		case 1:
			value = exe()->get_block(DMA2->LISR, 1, 6);
		break;
		case 2:
			value = exe()->get_block(DMA2->LISR, 1, 16);
		break;
		case 3:
			value = exe()->get_block(DMA2->LISR, 1, 22);
		break;
		case 4:
			value = exe()->get_block(DMA2->HISR, 1, 0);
		break;
		case 5:
			value = exe()->get_block(DMA2->HISR, 1, 6);
		break;
		case 6:
			value = exe()->get_block(DMA2->HISR, 1, 16);
		break;
		case 7:
			value = exe()->get_block(DMA2->HISR, 1, 22);
		break;
	default: break;
	}
	return value;
...
void DMA2_sr_clear_feif(uint8_t stream_n)
{
	switch(stream_n){
		case 0:
			exe()->write_block(&DMA2->LIFCR, 1, 0, 1);
		break;
		case 1:
			exe()->write_block(&DMA2->LIFCR, 1, 6, 1);
		break;
		case 2:
			exe()->write_block(&DMA2->LIFCR, 1, 16, 1);
		break;
		case 3:
			exe()->write_block(&DMA2->LIFCR, 1, 22, 1);
		break;
		case 4:
			exe()->write_block(&DMA2->HIFCR, 1, 0, 1);
		break;
		case 5:
			exe()->write_block(&DMA2->HIFCR, 1, 6, 1);
		break;
		case 6:
			exe()->write_block(&DMA2->HIFCR, 1, 16, 1);
		break;
		case 7:
			exe()->write_block(&DMA2->HIFCR, 1, 22, 1);
		break;
		default: break;
	}
}
...
{
	exe()->write_block(&DMA2_Stream0->CR, 3, 25, value);
}
void DMA2_stream0_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->CR, 2, 23, value);
}
void DMA2_stream0_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->CR, 2, 21, value);
}
void DMA2_stream0_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 19, state);
}
void DMA2_stream0_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 18, state);
}
void DMA2_stream0_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->CR, 2, 16, value);
}
void DMA2_stream0_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 15, state);
}
void DMA2_stream0_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->CR, 2, 13, value);
}
void DMA2_stream0_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->CR, 2, 11, value);
}
void DMA2_stream0_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 10, state);
}
void DMA2_stream0_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 9, state);
}
void DMA2_stream0_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 8, state);
}
void DMA2_stream0_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->CR, 2, 7, value);
}
void DMA2_stream0_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 5, state);
}
void DMA2_stream0_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 4, state);
}
void DMA2_stream0_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 3, state);
}
void DMA2_stream0_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 2, state);
}
void DMA2_stream0_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 1, state);
}
void DMA2_stream0_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream1->CR, 3, 25, value);
}
void DMA2_stream1_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->CR, 2, 23, value);
}
void DMA2_stream1_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->CR, 2, 21, value);
}
void DMA2_stream1_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 19, state);
}
void DMA2_stream1_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 18, state);
}
void DMA2_stream1_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->CR, 2, 16, value);
}
void DMA2_stream1_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 15, state);
}
void DMA2_stream1_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->CR, 2, 13, value);
}
void DMA2_stream1_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->CR, 2, 11, value);
}
void DMA2_stream1_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 10, state);
}
void DMA2_stream1_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 9, state);
}
void DMA2_stream1_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 8, state);
}
void DMA2_stream1_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->CR, 2, 7, value);
}
void DMA2_stream1_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 5, state);
}
void DMA2_stream1_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 4, state);
}
void DMA2_stream1_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 3, state);
}
void DMA2_stream1_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 2, state);
}
void DMA2_stream1_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 1, state);
}
void DMA2_stream1_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream2->CR, 3, 25, value);
}
void DMA2_stream2_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->CR, 2, 23, value);
}
void DMA2_stream2_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->CR, 2, 21, value);
}
void DMA2_stream2_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 19, state);
}
void DMA2_stream2_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 18, state);
}
void DMA2_stream2_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->CR, 2, 16, value);
}
void DMA2_stream2_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 15, state);
}
void DMA2_stream2_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->CR, 2, 13, value);
}
void DMA2_stream2_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->CR, 2, 11, value);
}
void DMA2_stream2_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 10, state);
}
void DMA2_stream2_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 9, state);
}
void DMA2_stream2_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 8, state);
}
void DMA2_stream2_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->CR, 2, 7, value);
}
void DMA2_stream2_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 5, state);
}
void DMA2_stream2_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 4, state);
}
void DMA2_stream2_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 3, state);
}
void DMA2_stream2_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 2, state);
}
void DMA2_stream2_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 1, state);
}
void DMA2_stream2_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream3->CR, 3, 25, value);
}
void DMA2_stream3_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->CR, 2, 23, value);
}
void DMA2_stream3_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->CR, 2, 21, value);
}
void DMA2_stream3_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 19, state);
}
void DMA2_stream3_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 18, state);
}
void DMA2_stream3_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->CR, 2, 16, value);
}
void DMA2_stream3_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 15, state);
}
void DMA2_stream3_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->CR, 2, 13, value);
}
void DMA2_stream3_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->CR, 2, 11, value);
}
void DMA2_stream3_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 10, state);
}
void DMA2_stream3_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 9, state);
}
void DMA2_stream3_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 8, state);
}
void DMA2_stream3_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->CR, 2, 7, value);
}
void DMA2_stream3_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 5, state);
}
void DMA2_stream3_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 4, state);
}
void DMA2_stream3_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 3, state);
}
void DMA2_stream3_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 2, state);
}
void DMA2_stream3_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 1, state);
}
void DMA2_stream3_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream4->CR, 3, 25, value);
}
void DMA2_stream4_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->CR, 2, 23, value);
}
void DMA2_stream4_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->CR, 2, 21, value);
}
void DMA2_stream4_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 19, state);
}
void DMA2_stream4_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 18, state);
}
void DMA2_stream4_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->CR, 2, 16, value);
}
void DMA2_stream4_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 15, state);
}
void DMA2_stream4_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->CR, 2, 13, value);
}
void DMA2_stream4_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->CR, 2, 11, value);
}
void DMA2_stream4_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 10, state);
}
void DMA2_stream4_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 9, state);
}
void DMA2_stream4_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 8, state);
}
void DMA2_stream4_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->CR, 2, 7, value);
}
void DMA2_stream4_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 5, state);
}
void DMA2_stream4_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 4, state);
}
void DMA2_stream4_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 3, state);
}
void DMA2_stream4_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 2, state);
}
void DMA2_stream4_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 1, state);
}
void DMA2_stream4_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream5->CR, 3, 25, value);
}
void DMA2_stream5_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->CR, 2, 23, value);
}
void DMA2_stream5_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->CR, 2, 21, value);
}
void DMA2_stream5_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 19, state);
}
void DMA2_stream5_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 18, state);
}
void DMA2_stream5_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->CR, 2, 16, value);
}
void DMA2_stream5_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 15, state);
}
void DMA2_stream5_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->CR, 2, 13, value);
}
void DMA2_stream5_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->CR, 2, 11, value);
}
void DMA2_stream5_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 10, state);
}
void DMA2_stream5_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 9, state);
}
void DMA2_stream5_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 8, state);
}
void DMA2_stream5_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->CR, 2, 7, value);
}
void DMA2_stream5_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 5, state);
}
void DMA2_stream5_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 4, state);
}
void DMA2_stream5_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 3, state);
}
void DMA2_stream5_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 2, state);
}
void DMA2_stream5_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 1, state);
}
void DMA2_stream5_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream6->CR, 3, 25, value);
}
void DMA2_stream6_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->CR, 2, 23, value);
}
void DMA2_stream6_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->CR, 2, 21, value);
}
void DMA2_stream6_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 19, state);
}
void DMA2_stream6_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 18, state);
}
void DMA2_stream6_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->CR, 2, 16, value);
}
void DMA2_stream6_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 15, state);
}
void DMA2_stream6_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->CR, 2, 13, value);
}
void DMA2_stream6_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->CR, 2, 11, value);
}
void DMA2_stream6_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 10, state);
}
void DMA2_stream6_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 9, state);
}
void DMA2_stream6_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 8, state);
}
void DMA2_stream6_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->CR, 2, 7, value);
}
void DMA2_stream6_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 5, state);
}
void DMA2_stream6_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 4, state);
}
void DMA2_stream6_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 3, state);
}
void DMA2_stream6_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 2, state);
}
void DMA2_stream6_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 1, state);
}
void DMA2_stream6_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream7->CR, 3, 25, value);
}
void DMA2_stream7_cr_mburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->CR, 2, 23, value);
}
void DMA2_stream7_cr_pburst(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->CR, 2, 21, value);
}
void DMA2_stream7_cr_ct(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 19, state);
}
void DMA2_stream7_cr_dbm(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 18, state);
}
void DMA2_stream7_cr_pl(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->CR, 2, 16, value);
}
void DMA2_stream7_cr_pincos(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 15, state);
}
void DMA2_stream7_cr_msize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->CR, 2, 13, value);
}
void DMA2_stream7_cr_psize(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->CR, 2, 11, value);
}
void DMA2_stream7_cr_minc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 10, state);
}
void DMA2_stream7_cr_pinc(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 9, state);
}
void DMA2_stream7_cr_circ(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 8, state);
}
void DMA2_stream7_cr_dir(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->CR, 2, 7, value);
}
void DMA2_stream7_cr_pfctrl(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 5, state);
}
void DMA2_stream7_cr_tcie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 4, state);
}
void DMA2_stream7_cr_htie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 3, state);
}
void DMA2_stream7_cr_teie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 2, state);
}
void DMA2_stream7_cr_dmeie(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 1, state);
}
void DMA2_stream7_cr_en(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->CR, 1, 0, state);
}
...
{
	exe()->write_block(&DMA2_Stream0->FCR, 1, 7, state);
}
void DMA2_stream0_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->FCR, 3, 3, value);
}
void DMA2_stream0_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream0->FCR, 1, 2, state);
}
void DMA2_stream0_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream0->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA2_Stream1->FCR, 1, 7, state);
}
void DMA2_stream1_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->FCR, 3, 3, value);
}
void DMA2_stream1_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream1->FCR, 1, 2, state);
}
void DMA2_stream1_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream1->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA2_Stream2->FCR, 1, 7, state);
}
void DMA2_stream2_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->FCR, 3, 3, value);
}
void DMA2_stream2_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream2->FCR, 1, 2, state);
}
void DMA2_stream2_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream2->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA2_Stream3->FCR, 1, 7, state);
}
void DMA2_stream3_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->FCR, 3, 3, value);
}
void DMA2_stream3_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream3->FCR, 1, 2, state);
}
void DMA2_stream3_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream3->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA2_Stream4->FCR, 1, 7, state);
}
void DMA2_stream4_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->FCR, 3, 3, value);
}
void DMA2_stream4_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream4->FCR, 1, 2, state);
}
void DMA2_stream4_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream4->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA2_Stream5->FCR, 1, 7, state);
}
void DMA2_stream5_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->FCR, 3, 3, value);
}
void DMA2_stream5_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream5->FCR, 1, 2, state);
}
void DMA2_stream5_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream5->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA2_Stream6->FCR, 1, 7, state);
}
void DMA2_stream6_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->FCR, 3, 3, value);
}
void DMA2_stream6_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream6->FCR, 1, 2, state);
}
void DMA2_stream6_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream6->FCR, 2, 0, value);
}
...
{
	exe()->write_block(&DMA2_Stream7->FCR, 1, 7, state);
}
void DMA2_stream7_fcr_fs(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->FCR, 3, 3, value);
}
void DMA2_stream7_fcr_dmdis(uint8_t state)
{
	exe()->write_block(&DMA2_Stream7->FCR, 1, 2, state);
}
void DMA2_stream7_fcr_fth(uint8_t value)
{
	exe()->write_block(&DMA2_Stream7->FCR, 2, 0, value);
}
...
void dma2_circ_cfg(volatile uint32_t* p_addr, volatile uint32_t* m_addr, uint8_t stream_n, uint8_t channel_n, uint16_t quant_d, uint8_t p_size, uint8_t m_size, uint8_t priority, uint8_t dir)
{
	...
	if( p_addr && m_addr ){
		/*** Verify Ready for Parameter ***/
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 0, 0);
		for(time_out = 200; exe()->get_block((DMA2_Stream0 + stream_n)->CR, 1, 0) && time_out; time_out--);
		/*** Parameter Configure ***/
		(DMA2_Stream0 + stream_n)->PAR = (volatile uint32_t) p_addr;
		(DMA2_Stream0 + stream_n)->M0AR = (volatile uint32_t) m_addr;
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 5, 0); // 0 -> dma, 1 -> peri
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 3, 25, channel_n); // channel
		(DMA2_Stream0 + stream_n)->NDTR = quant_d; //
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 2, 13, m_size); // msize 2 -> 32bit
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 2, 11, p_size); // psize 1 -> 16bit
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 2, 16, priority); // priority
		if(dir){
			exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 2, 6, 1); // DIR
			exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 9, 1); // PINC
			exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 10, 0); // MINC
		}else{
			exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 2, 6, 0); // DIR
			exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 9, 0); // PINC
			exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 10, 1); // MINC
		}
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 8, 1); // CIRC
		exe()->write_block(&(DMA2_Stream0 + stream_n)->CR, 1, 0, 1); // ENABLE
	}
}
/*** Inic FUNC ***/
STM32FXXX_DMA_func* stm32fxxx_dma2_func_inic(void)
