...
typedef struct ST7789
{
	...
	void (*spi_tx)(ST7789_par* par, uint8_t d);
	...
	void (*drawfont16x16)(ST7789_par* par, char c, uint16_t x, uint16_t y, uint16_t fg, uint16_t bg);
	void (*drawstring12x16)(ST7789_par* par, const char* str, uint16_t x, uint16_t y, uint16_t fg, uint16_t bg);
	void (*drawfont24x24)( ST7789_par* par, char c, uint16_t x, uint16_t y, uint16_t fg, uint16_t bg );
